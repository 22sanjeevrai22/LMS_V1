                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                @enderror"
                                    ...
                                    value="{{ old('contact_number', $person->contact_number) }}" required />
            ...
            <div class="card col-xl-4">
                ...
                <div class="card-body text-center">
                    ...
                    <img class="img-account-profile rounded-circle mb-2"
                        src="{{ $person->getFirstMediaUrl('cover') ?: asset('assets/img/demo/user-placeholder.svg') }}"
                        id="preview_image" alt="Profile Picture" />
