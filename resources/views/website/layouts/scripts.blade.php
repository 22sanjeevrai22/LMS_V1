<script type='text/javascript' src="{{asset('website/js/jquery/jquery.js')}}"></script>
    ...
    <script type='text/javascript' src="{{asset('website/plugins/revslider/public/assets/js/rs6.min.js')}}"></script>
    ...
    <script type='text/javascript' src="{{asset('website/plugins/goodlayers-core/plugins/script.js')}}"></script>
    <script type='text/javascript'>
        /* <![CDATA[ */
        var gdlr_core_pbf = {
            "admin": "",
    ...
    <script type='text/javascript' src="{{asset('website/plugins/zeno-font-resizer/js/js.cookie.js')}}"></script>
    <script type='text/javascript' src="{{asset('website/plugins/zeno-font-resizer/js/jquery.fontsize.js')}}"></script>
    <script type='text/javascript' src="{{asset('website/plugins/google-map-plugin/assets/js/maps.js')}}"></script>
    <script type='text/javascript' src="{{asset('website/js/jquery/ui/effect.min.js')}}"></script>
    <script type='text/javascript' src="{{asset('website/js/jquery.mmenu.js')}}"></script>
    <script type='text/javascript' src="{{asset('website/js/jquery.superfish.js')}}"></script>
